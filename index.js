...
const owner = ["1150483834857586708","","","","",]; // اي دي الاونر اللي يقدر يتحكم في اوامر الاونر
  ...
  if (message.content.toLowerCase().startsWith(`${prefix}help`)) {
    ...
    const embed = new Discord.MessageEmbed()
      ...
      .setDescription(`
          ...
          5.  ${prefix}kick \`يعطي طرد\`
          6.  ${prefix}mute \`يعطي ميوت\`
          7.  ${prefix}unmute \`يفك الميوت\`
          8.  ${prefix}clear \`يمسح رسائل\`
          9.  ${prefix}hide \`يخلي الروم خاص\`
          10. ${prefix}show \`يخلي الروم يشوفها الجميع\`
          11. ${prefix}lock \`يقفل الروم\`
          12. ${prefix}unlock \`يفتح الروم\`
          13. ${prefix}banner \`يجيب لك بنر احد\`
          14. ${prefix}timeout \`يعطي تايم اوت\`
          15. ${prefix}top-credits \`يخليك تشوف توب 10 على الكريدت\`
          16. ${prefix}antibots on \`يمنع دخول البوتات\`
          17. ${prefix}antibots off \`يلغي منع دخول البوتات\`
          18. ${prefix}antibots \`اشوف البوتات اللي دخلت\`
          19. ${prefix}reaction-roles \`رياكشن رول\`
          20. ${prefix}tax \`يحسب لك ضريبه بروبوت\`
          21. ${prefix}role \`يدي احد رتبه\`
          22. ${prefix}role removed \`ازاله رتبه من احد\`
          23. ${prefix}fedback \`تقييم شخص\`
          24. ${prefix}hide-all \`اخفاء كل الرومات\`
          25. ${prefix}show-all \`اظهار كل الرومات\`
          26. ${prefix}dmuser \`بيبعث رساله لاحد في الخاص\`
          27. ${prefix}set-channel \`تحديد تسجيلات التقديم على الاداره\`
          28. ${prefix}set-role \`تحديد رتبه الاداره لما شخص يتقبل ياخدها\`
          29. ${prefix}set-highrole \`تحديد رتبه للاداره الرفض والقبول\`
          30. ${prefix}setup \`تنزيل تقديم الاداره\`
          31. ${prefix}members \`حاله الاعضاء\`
          32. ${prefix}all-unban \`إلغاء حظر الكل\`
          33. ${prefix}ping \`يوريك بنج البوت\`
          34. ${prefix}developer \`يوريك معلومات عن مطور البوت\`
          35. ${prefix}user \`معلومات عنك انت\`
          36. ${prefix}avatar \`يجيب لك الافاتار بتاعك\`
          37. ${prefix}avatar server \`يجيب افاتار السيرفر بس من دون تحميل\`
          38. ${prefix}setnick \`تغيير اسم احد\`
          39. ${prefix}invite \`يجيب لك انفايت للبوت بتاعك\`
          40. ${prefix}warn \`تدي انذار للشخص\`
          `)
...
client.on("messageCreate", async message => {
  if (message.guild.id != "1051239628583211088") return; // اي دي السيرفر
  if (message.channel.id != "1135920564050088057") return; // اي دي الروم
...
// تعديل مهم
// Code Suggestion
let sug = ["1181325482508161144","","","",""]; // حط اي دي روم الاقتراحات
...
🆔丨\`ID Discord : 1006595671777882174\`

💫丨\`AEG : 16\`

👑丨\`Profile By\` <@1150483834857586708>
